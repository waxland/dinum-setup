---
title: ADR-0002 — Rendu Tri-Format Unifié (Callout, Card, Link)
sidebar_label: ADR-0002 Rendu Tri-Format
description: Normalisation des 3 formats d'affichage visuel des sources connectées dans BlockNote.
---
