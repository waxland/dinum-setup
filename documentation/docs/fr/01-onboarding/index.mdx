...
<FeatureGrid cols={3}>
  ...
  <FeatureCard
    ...
    description="Dossier technique complet, 12 connecteurs, SDK développeur et architecture en 3 pôles."
    href="/08-slash"
    badge="Socle"
  />
  <FeatureCard
    icon="🚀"
    title="09. Pull Requests & Contributions"
    description="Dossiers de PR officiels pour suitenumerique/docs (VMs, packages) et TypeCellOS/BlockNote (RFC)."
    href="/09-PR"
    badge="Upstream"
  />
</FeatureGrid>
