...
| **Statut Pull Request** | 🟢 **Soumise & Ouverte en ligne : [PR #2703](https://github.com/suitenumerique/docs/pull/2703)** |
| **Titre officiel** | `✨(dev) make development URLs configurable for remote servers and VMs` |
