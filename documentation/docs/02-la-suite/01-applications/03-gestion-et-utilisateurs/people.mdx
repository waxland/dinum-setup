...
🔗 **Technologies & Références :** [Documentation Django 5](https://docs.djangoproject.com/) • [Documentation Django REST Framework](https://www.django-rest-framework.org/) • [Protocole OpenID Connect](https://openid.net/)
