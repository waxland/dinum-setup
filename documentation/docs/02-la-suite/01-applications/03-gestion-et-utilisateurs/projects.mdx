...
🔗 **Technologies & Références :** [Documentation Sails.js](https://sailsjs.com/) • [Documentation React 18](https://react.dev/) • [Design System Cunningham](https://github.com/openfun/cunningham) • [Knex.js SQL Query Builder](https://knexjs.org/)
