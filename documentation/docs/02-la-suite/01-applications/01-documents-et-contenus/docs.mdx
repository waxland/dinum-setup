...
🔗 **Technologies & Références :** [Éditeur BlockNote](https://www.blocknotejs.org/) • [Documentation Yjs CRDT](https://docs.yjs.dev/) • [Django REST Framework](https://www.django-rest-framework.org/) • [Next.js Framework](https://nextjs.org/)
...
| **Swagger API**   | [http://207.175.155.66:8071/api/v1.0/swagger/](http://207.175.155.66:8071/api/v1.0/swagger/)     | —                                                       | Documentation interactive de l'API REST     |
