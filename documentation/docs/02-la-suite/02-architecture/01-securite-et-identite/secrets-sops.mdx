...
🔗 **Outils de chiffrement :** [Dépôt GitHub Mozilla SOPS](https://github.com/getsops/sops) • [Dépôt GitHub FiloSottile/age](https://github.com/FiloSottile/age) • [Guide GitOps et gestion des secrets ANSSI](https://cyber.gouv.fr/)
