...
export const MOCK_SOURCES: Record<string, SourceEntityProps[]> = {
  ...
  procurement: [
    {
      ...
      provider: "Marchés Publics / BOAMP",
      title: "Fourniture d'une infrastructure cloud souveraine",
      subtitle: "Direction Interministérielle du Numérique (DINUM)",
      status: "OFFRES OUVERTES",
      statusBadgeColor: "info",
      contentHtml:
        "<p>Acquisition de prestations d'hébergement qualifié SecNumCloud pour La Suite Numérique.</p>",
      summary: "Marché public d'infrastructure cloud souveraine pour 250 000 agents de l'État.",
      metaField1Label: "AAPC",
      metaField1Value: "26-042819",
      metaField2Label: "Procédure",
      metaField2Value: "MAPA",
      metaField3Label: "Clôture",
      metaField3Value: "15/10/2026",
      displayMode: "card",
  ...
  grant: [
    {
      ...
      provider: "Aides-Territoires / ANCT",
      title: "Fonds Vert — Rénovation énergétique des bâtiments publics",
      subtitle: "Ministère de la Transition Écologique & ANCT",
      status: "CANDIDATURES OUVERTES",
      statusBadgeColor: "success",
      contentHtml:
        "<p>Financement des travaux de performance énergétique globale sur les écoles et mairies.</p>",
      summary: "Subvention d'État pour accélérer la décarbonation du patrimoine bâti public.",
      metaField1Label: "Financeur",
      metaField1Value: "Fonds Vert",
      metaField2Label: "Taux max",
      metaField2Value: "80%",
      metaField3Label: "Clôture",
      metaField3Value: "31/12/2026",
      displayMode: "card",
  ...
  insee: [
    {
      ...
      provider: "Données Locales INSEE",
      ...
      statusBadgeColor: "info",
      contentHtml:
        "<p>Paris concentre 17,2% des emplois d'Île-de-France avec un taux d'activité de 78,4%.</p>",
      summary: "Statistiques officielles de population et d'emploi produites par l'INSEE.",
      metaField1Label: "Population",
      metaField1Value: "2 133 111 hab.",
      metaField2Label: "Densité",
      metaField2Value: "20 238 hab./km²",
      metaField3Label: "Emplois",
      metaField3Value: "1 842 500",
      displayMode: "card",
  ...
  agent: [
    {
      ...
      provider: "Annuaire du Service Public",
      title: "Direction Interministérielle du Numérique (DINUM)",
      subtitle: "Services du Premier ministre",
      status: "ANNUAIRE CERTIFIÉ",
      statusBadgeColor: "info",
      contentHtml:
        "<p>Coordination des systèmes d'information et développement des communs numériques souverains de l'État.</p>",
      summary: "Administration centrale chargée de la transformation numérique publique.",
      metaField1Label: "Courriel",
      metaField1Value: "contact@numerique.gouv.fr",
      metaField2Label: "Téléphone",
      metaField2Value: "01 71 21 00 00",
      metaField3Label: "Adresse",
      metaField3Value: "20 avenue de Ségur, 75007 Paris",
      displayMode: "card",
  ...
  cadastre: [
    {
      sourceType: "cadastre",
      sourceId: "CAD-75107-000-AK-0042",
      provider: "Cadastre & Parcelles (DGFiP)",
      title: "Parcelle Section AK n° 0042 (Paris 7e)",
      subtitle: "DGFiP / IGN — Commune de Paris 7e",
      status: "CADASTRE CERTIFIÉ",
      statusBadgeColor: "success",
      contentHtml:
        "<p>Parcelle foncière administrative située au 20 avenue de Ségur (Ensemble Ségur-Fontenoy).</p>",
      summary: "Plan cadastral informatisé officiel de l'État.",
      metaField1Label: "Contenance",
      metaField1Value: "14 520 m²",
      metaField2Label: "Feuille",
      metaField2Value: "000 AK 01",
      metaField3Label: "Section",
      metaField3Value: "AK 0042",
      displayMode: "card",
  ...
  demarche: [
    {
      ...
      title: "Demande d'habilitation La Suite Numérique",
      subtitle: "Direction Interministérielle du Numérique",
      status: "FORMULAIRE EN LIGNE",
      statusBadgeColor: "success",
      contentHtml:
        "<p>Téléprocédure d'habilitation pour les agents et référents ministériels.</p>",
      summary: "Démarche dématérialisée ouverte sur demarches-simplifiees.fr.",
      metaField1Label: "Procédure",
      metaField1Value: "n° 84290",
      metaField2Label: "Délai moyen",
      metaField2Value: "48 heures",
      metaField3Label: "Statut",
      metaField3Value: "Publiée",
      displayMode: "card",
  ...
  opendata: [
    {
      ...
      provider: "data.gouv.fr / Open Data",
      title: "Base Sirene des entreprises et établissements",
      subtitle: "data.gouv.fr — Ministère de l'Économie / INSEE",
      status: "LICENCE OUVERTE",
      statusBadgeColor: "info",
      contentHtml:
        "<p>Répertoire exhaustif de toutes les entreprises et établissements en France (SIREN/SIRET).</p>",
      summary: "Jeu de données certifié et ouvert du service public de la donnée.",
      metaField1Label: "Format",
      metaField1Value: "CSV, Parquet",
      metaField2Label: "Fréquence",
      metaField2Value: "Quotidienne",
      metaField3Label: "Téléchargements",
      metaField3Value: "4.8M/mois",
      displayMode: "card",
  ...
  custom: [
    {
      ...
      provider: "Albert IA Souveraine",
      title: "Préavis de démission d'un agent contractuel",
      subtitle: "Synthèse Albert (Décret n° 86-83 - Art. 48)",
      status: "CERTIFIÉ ALBERT",
      statusBadgeColor: "success",
      contentHtml:
        "<p>L'agent contractuel qui démissionne doit respecter un préavis : 8j (<6 mois), 1 mois (6m à 2 ans), 2 mois (>=2 ans).</p>",
      summary: "Durée légale du préavis de démission applicable aux agents non titulaires.",
      metaField1Label: "Source",
      metaField1Value: "DGAFP",
      metaField2Label: "Modèle",
      metaField2Value: "Albert-Large",
      metaField3Label: "Confiance",
      metaField3Value: "96%",
      displayMode: "callout",
