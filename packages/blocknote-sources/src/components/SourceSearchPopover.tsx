...
const THEMATIC_TABS: ThematicTab[] = [
  {
    ...
    icon: '⚡',
    types: ['law', 'company', 'parliament', 'address', 'procurement', 'grant', 'insee', 'agent', 'cadastre', 'demarche', 'opendata', 'custom'],
  },
  {
    id: 'legal',
    label: 'Juridique & Lois',
    icon: '⚖️',
    types: ['law', 'parliament', 'custom'],
  },
  {
    id: 'economy',
  ...
  },
  {
    ...
    icon: '📍',
    types: ['address', 'cadastre', 'insee', 'demarche', 'opendata', 'agent'],
  },
];
