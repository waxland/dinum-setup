...
from lasuite_sources.providers.federation.inspire_address import InspireAddressFederatedProvider
from lasuite_sources.providers.federation.inspire_cadastre import InspireCadastreFederatedProvider
