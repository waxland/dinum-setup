...
class DataOverheidSourceProvider(BaseSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("DATAOVERHEID_MOCK_ENABLED", "true").lower() in ("true", "1", "yes")
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        ...
        return matched[:limit] if matched else MOCK_DATAOVERHEID_RESULTS[:limit]
