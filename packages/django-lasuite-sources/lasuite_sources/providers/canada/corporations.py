...
MOCK_CORPORATIONS_RESULTS: List[SourceSearchResult] = [
    {
        ...
        "raw_payload": {"corp_id": "1234567", "bn9": "849201948", "jurisdiction": "Federal"},
    },
]


class CorporationsCanadaSourceProvider(BaseSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("CORP_CA_MOCK_ENABLED", "true").lower() in ("true", "1", "yes")
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        ...
        return matched[:limit] if matched else MOCK_CORPORATIONS_RESULTS[:limit]
