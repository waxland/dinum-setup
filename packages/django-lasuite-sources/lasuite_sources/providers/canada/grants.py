...
class CanadaGrantsSourceProvider(DemoSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("CAN_GRANTS_MOCK_ENABLED", "true").lower() in (
            "true",
            "1",
            "yes",
        )
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        return self.demo_search(MOCK_CAN_GRANTS_RESULTS, query, limit)
