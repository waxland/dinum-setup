...
MOCK_PARLIAMENT_CA_RESULTS: List[SourceSearchResult] = [
    {
        ...
        "raw_payload": {"bill_id": "C-27", "parliament": "44", "chamber": "House of Commons"},
    },
]


class ParliamentCanadaSourceProvider(BaseSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("PARL_CA_MOCK_ENABLED", "true").lower() in ("true", "1", "yes")
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        ...
        return matched[:limit] if matched else MOCK_PARLIAMENT_CA_RESULTS[:limit]
