...
MOCK_TED_RESULTS: List[SourceSearchResult] = [
    {
        ...
        "raw_payload": {"ted_id": "129481-2026", "buyer": "DG DIGIT", "cpv": "72200000"},
    },
    {
...
class TedSourceProvider(BaseSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("TED_MOCK_ENABLED", "true").lower() in ("true", "1", "yes")
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        ...
        return matched[:limit] if matched else MOCK_TED_RESULTS[:limit]
