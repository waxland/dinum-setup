...
class WhoSourceProvider(BaseSourceProvider):
    ...
    def __init__(self):
        self.mock_mode = os.getenv("WHO_MOCK_ENABLED", "true").lower() in ("true", "1", "yes")
    ...
    def search(self, query: str, limit: int = 10) -> List[SourceSearchResult]:
        ...
        return matched[:limit] if matched else MOCK_WHO_RESULTS[:limit]
