---
title: Skill Conception d'Évolutions & ADR (design-change)
...
- **Exemple d'extension BlockNote :** [Tutoriel /law Légifrance](/06-tutoriels/01-developpement-applicatif/commande-slash-blocknote-legifrance)
