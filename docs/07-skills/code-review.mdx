---
title: Skill Revue de Code & Audit de Diff (code-review)
...
- [ ] **Conventions de nommage :** Conventional Commits (`feat:`, `fix:`, `docs:`), typage TypeScript strict (pas de `any` injustifié).
- [ ] **Conformité DSFR :** Pas de classes CSS inventées, utilisation des composants officiels.
