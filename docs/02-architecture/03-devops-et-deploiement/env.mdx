...
🔗 **Principes & Références :** [Méthodologie The Twelve-Factor App (III. Config)](https://12factor.net/fr/config) • [Documentation django-configurations](https://django-configurations.readthedocs.io/) • [Documentation python-dotenv](https://pypi.org/project/python-dotenv/)
