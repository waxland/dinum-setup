...
🔗 **Références officielles :** [Documentation Keycloak OIDC](https://www.keycloak.org/docs/latest/securing_apps/) • [Documentation ProConnect](https://proconnect.gouv.fr/) • [RFC 6749 (The OAuth 2.0 Authorization Framework)](https://datatracker.ietf.org/doc/html/rfc6749)
