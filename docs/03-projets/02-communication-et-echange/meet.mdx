...
🔗 **Technologies & Références :** [Documentation LiveKit SFU](https://docs.livekit.io/) • [Standard WebRTC](https://webrtc.org/) • [LiveKit React Components](https://docs.livekit.io/frontends/react/)
